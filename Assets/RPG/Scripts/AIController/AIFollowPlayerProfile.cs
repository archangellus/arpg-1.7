...
public class AIFollowPlayerProfile : AIProfile
{
    ...
    private bool TryGetGatherTarget(out Collectible gatherTarget)
    {
        ...
        foreach (var collectible in Collectible.all)
        {
            ...
            float distToPetSqr = (collectible.transform.position - playerTransform.position).sqrMagnitude;
    ...
    private void ScanForCollectiblesInRange()
    {
        ...
        foreach (var collectible in Collectible.all)
        {
            ...
            float sqrDistance = (collectible.transform.position - playerTransform.position).sqrMagnitude;
    ...
    private void ProcessPendingCollectibles()
    {
        ...
        foreach (var pair in pendingCollectibles)
        {
            ...
            {
                float distToPet = Vector3.Distance(collectible.transform.position, playerTransform.position);
