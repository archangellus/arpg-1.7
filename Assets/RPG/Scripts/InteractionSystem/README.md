...
1. In the Unity Editor, select **Tools > PLAYER TWO > ARPG Project > Create Interaction Manager**.
2. Assign the player `Entity` if it was not found automatically.
...
Grab mode and inspection mode are intentionally not included.
