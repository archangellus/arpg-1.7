...
namespace PLAYERTWO.ARPGProject
{
    public class ArmorAttributes : ItemAttributes
    {
        ...
        protected virtual bool CanAddAttribute(int index, int totalCount, int minAttributes, int maxAttributes)
        {
            return index < maxAttributes || (minAttributes > 0 && index < minAttributes);
        }
