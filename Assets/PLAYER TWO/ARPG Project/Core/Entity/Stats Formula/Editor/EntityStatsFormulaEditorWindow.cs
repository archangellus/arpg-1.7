...
namespace PLAYERTWO.ARPGProjectEditorTools
{
    ...
    static class StatsFormulaEditorColors
    {
        public static readonly Color WindowBackground = new Color(0.09f, 0.10f, 0.12f, 1f);
        public static readonly Color ToolbarBackground = new Color(0.13f, 0.15f, 0.18f, 1f);
        public static readonly Color ToolbarAccent = new Color(0.33f, 0.56f, 0.92f, 1f);
        public static readonly Color PanelBackground = new Color(0.11f, 0.12f, 0.15f, 0.96f);
    }
    ...
    public class EntityStatsFormulaEditorWindow : EditorWindow
    {
        ...
        void BuildWindow()
        {
            ...
            rootVisualElement.style.backgroundColor = StatsFormulaEditorColors.WindowBackground;
            ...
            toolbar.style.backgroundColor = StatsFormulaEditorColors.ToolbarBackground;
            ...
            var title = new Label("Stats Formula Graph")
            {
                ...
                style =
                {
                    ...
                    fontSize = 15,
                    color = StatsFormulaEditorColors.ToolbarAccent,
                    marginRight = 12f,
                    marginLeft = 2f,
                }
            };
            ...
            m_previewLabel = new Label("Preview: —")
            {
                ...
                style =
                {
                    ...
                    backgroundColor = StatsFormulaEditorColors.PanelBackground,
    ...
    class StatsFormulaGraphView : GraphView
    {
        ...
        {
            node.style.backgroundColor = StatsFormulaEditorColors.PanelBackground;
