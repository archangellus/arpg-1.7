    ...
    public class EntityStatsFormulaEditorWindow : EditorWindow
    {
        ...
        void PopulateSelectedBuiltInExample()
        {
            ...
            var confirmed = EditorUtility.DisplayDialog(
                ...
                $"Replace the {m_exampleTarget} formula with a disabled example based on the built-in EntityStatsManager calculation?",
                "Replace",
                "Cancel"
            );
            ...
            Undo.RecordObject(m_graphAsset, $"Load {m_exampleTarget} Example Formula");
            AddOrReplaceFormula(EntityStatsFormulaExampleBuilder.CreateBuiltInExample(m_exampleTarget));
        ...
        void PopulateAllBuiltInExamples()
        {
            ...
            var confirmed = EditorUtility.DisplayDialog(
                ...
                "Replace all formulas in this graph with disabled examples based on the built-in EntityStatsManager calculations?",
                "Replace All",
                "Cancel"
            );
            ...
            Undo.RecordObject(m_graphAsset, "Load All Built-In Example Formulas");
            m_graphAsset.formulas.Clear();

            foreach (EntityStatsFormulaTarget target in Enum.GetValues(typeof(EntityStatsFormulaTarget)))
                AddOrReplaceFormula(EntityStatsFormulaExampleBuilder.CreateBuiltInExample(target));
        ...
        bool ValidateGraphForExamples()
        {
            ...
            EditorUtility.DisplayDialog(
                ...
                "Create or assign a formula graph asset before loading built-in examples.",
                "OK"
            );
            return false;
        }
